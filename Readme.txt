...
- **Модуль 01 / Module 01**
  ...
  - Сборный проект / Common project - *Project_03*
- **Модуль 02 / Module 02**  
  - Введение в машинное обучение / Introduction to machine learning  - *Project_04*
  - Обучение с учителем / Supervised learning  - *Project_05*
  - Машинное обучение в бизнесе / Machine learning in business  - *Project_06*
  - Сборный проект / Common project  - *Project_07*
- **Модуль 03 / Module 03**  
  - Линейная алгебра / Linear algebra  - *Project_08*
  - Численные методы (градиентный бустинг) / Numerical analysis (gradient boosting)  - *Project_09*
  - Временные ряды / Time series  - *Project_10*
  - Машинное обучение для текстов / Machine learning for texts  - *Project_11*
- **Модуль 04 / Module 04**  
  - Компьютерное зрение / Computer vision  - *Project_13*
...
The communication operator "Niedinogorazryva.com" wants to learn how to predict the outflow of customers. If it turns out that the user is planning to leave, he will be offered promo codes and special conditions. The operator's team collected personal data about some customers, information about their tariffs and contracts.